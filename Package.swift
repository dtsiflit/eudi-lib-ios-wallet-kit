...
let package = Package(
    ...
    dependencies: [
		...
		.package(url: "https://github.com/niscy-eudiw/eudi-lib-ios-openid4vci-swift.git", exact: "0.0.10"),
		.package(url: "https://github.com/niscy-eudiw/eudi-lib-ios-siop-openid4vp-swift.git", exact: "0.0.76"),
	],
    targets: [
